...
//   const response = await axios.get(
//     `https://pixabay.com/api/?key=${API_KEY}&q=${searchQuery}&image_type=photo&per_page=12`
//   );

//   // отримуємо масив зображень з відповіді API
//   const images = response.data.hits;

//   // створюємо розмітку карток зображень і додаємо їх до галереї
//   const markup = images
//     .map(
//       image => `
